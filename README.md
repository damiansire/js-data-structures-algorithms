...
as study and reference material. Each module exports its API so it can be
imported and tested in isolation: CommonJS `module.exports` in the JavaScript
files, ESM `export` in the ones migrated to TypeScript.
